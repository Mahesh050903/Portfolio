  ...
  return (
    <div className="mt-3 lg:mt-16" id="skills">
      <div className="px-5 lg:px-28">
        ...
        {/* Skill Cards - Updated with Flexbox for perfect center alignment */}
        <div className="flex flex-wrap justify-center gap-6 lg:gap-10 text-lg font-bold mt-7 lg:mt-16 w-full max-w-6xl mx-auto">
          {skills.map((skill) => (
            <motion.div
              key={skill.id}
