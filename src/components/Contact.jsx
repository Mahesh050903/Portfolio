...
export default function Contact() {
  ...
  const socialLinks = [
    { Icon: BiLogoGmail, link: "mailto:maheshbatukbhai170@gmail.com" },
    { Icon: IoLogoLinkedin, link: "https://www.linkedin.com/in/mahesh-makvana" },
    { Icon: IoLogoTwitter, link: "#" },  // Agar Twitter nahi hai, toh is line ko hata sakte ho
    { Icon: BsGithub, link: "https://github.com/Mahesh050903" }
  ];
        ...
        >
          ...
          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            <motion.a
              ...
              href="mailto:maheshbatukbhai170@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
